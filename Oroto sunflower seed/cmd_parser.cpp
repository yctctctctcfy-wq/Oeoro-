...
void initCommandParser() {
    std::cout << GREEN << "[PARSER] Command parser initialized successfully" << RESET << "\n";
    std::cout << GREEN << "[PARSER] Extended command set loaded (File, System, Network, Security)" << RESET << "\n";
    std::cout << GREEN << "[PARSER] Job management system ready" << RESET << "\n";
}
